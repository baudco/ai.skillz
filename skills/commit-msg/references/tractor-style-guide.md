...
- Max line length: 67 display-columns (fill width)
...
The default footer should credit the active AI coding harness and
model/provider for helping generate the commit msg content:
...
by the AI coding harness, instead add:
